        ...
        <table class="table text-xl " id="myTable" style="table-layout:fixed;">
          ...
          <tbody>
            ...
            <tr >
              ...
              <td><a href="{{route('comenzar_encuesta_2020',[$c->correo,$Egresado->cuenta,$Egresado->carrera])}}"> <button class="btn" style="background-color:{{Auth::user()->color}} ; color:white; margin: 0.1vw"> <i class="fas fa-paper-plane" aria-hidden="true"> </i> &nbsp; ENVIAR AVISO <br> Y ENCUESTAR</button></a>
              </td>
            </tr>
            @endforeach
          </tbody>
